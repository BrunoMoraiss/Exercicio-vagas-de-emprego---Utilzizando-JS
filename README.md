Esse foi o exercicio final do modulo logica de programação com javascript, coloquei as especificações do exercicio somente para ter um melhor entendimento.

Nesse exercicio acredito que poderia ter algumas melhorias, com os meus avanços de estudo poderia fazer diversas melhorias, mas acho importante colocar assim e comparar a evolução posteriormente. 
